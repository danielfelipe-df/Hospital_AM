...
void trace_reaction(group &Out, group &In, int index, Workers *family, int typeout, int typein, double time, bool is_traced);
...
void aux_main(int num, std::map<std::string, group> &Val, std::map<std::string, group> &Vba, Workers *altos, Workers *bajos, Crandom &ran, double cons1, double cons2, bool type, std::string index, bool pre);
