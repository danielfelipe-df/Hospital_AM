...
int main(void)
{
  ...
  for(unsigned int i=0; i<ensemble; i++){
	...
	tested_isolated(susTal, susal, altos, ti_in[0], 1, 1);
	tested_isolated(susTba, susba, bajos, ti_in[0], 1, 1);
	tested_isolated(expTal, expal, altos, ti_in[0], 1, 1);
	tested_isolated(expTba, expba, bajos, ti_in[0], 1, 1);
	tested_isolated(recTal, recIal, altos, ti_in[0], 1, 1);
	tested_isolated(recTba, recIba, bajos, ti_in[0], 1, 1);
